#if UNITY_EDITOR
using FreschGames.Core.ValueDataSystem;
using UnityEditor;
using UnityEngine;
...
namespace FreschGames.Core.Editor.PropertyDrawer
{
    ...
    public class ValueReferenceDrawer : UnityEditor.PropertyDrawer
    {
        /// <summary>
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            SerializedProperty variable = property.FindPropertyRelative("ValueData");
